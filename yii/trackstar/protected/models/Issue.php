...
class Issue extends TrackStarActiveRecord
{
	...
	public function getStatusOptions(){
		...
		return array(self::TYPE_NOT_YET_STARTED => 'Not yet started', self::TYPE_STARTED => 'Started', self::TYPE_FINISHED => 'Finished');
	}
	...
	public function getAllowedStatusRange(){
		return array(self::TYPE_NOT_YET_STARTED, self::TYPE_STARTED, self::TYPE_FINISHED);
	}
