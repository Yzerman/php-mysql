...
$this->breadcrumbs=array(
 ...
 $this->menu=array(
     ...
     array('label'=>'Delete Issue', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure youwant to delete this item?')),
...
<?php $this->widget('zii.widgets.CDetailView', array(
     ...
     array(
     	'name'=>'requester_id','value'=>isset($model->requester)?CHtml::encode(
     		$model->requester->username):"unknown"),)
)); ?>
